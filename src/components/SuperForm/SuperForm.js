...
const SuperForm = () => {
    ...
    const handleKeyUp = e => {
        e.preventDefault();
        if (e.keyCode === ENTER && e.target.id ) return formData[e.target.id].nextInput.focus();
    ...
    return (
        <form ref={signupForm} action="" noValidate onKeyUp={handleKeyUp} onKeyDown={handleKeyDown}>
